...
/* harmony import */ var _modules_Notify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Notify */ "./src/js/modules/Notify.js");
/* harmony import */ var _modules_SliderGallery__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/SliderGallery */ "./src/js/modules/SliderGallery.js");
/* harmony import */ var _modules_NavTabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/NavTabs */ "./src/js/modules/NavTabs.js");
...
var NavTabs = {
  ...
  init: function init() {
    $(document).on("click", ".js-nav-tabs__item", this._handleTabClick.bind(this));
  }
};
$(function () {
  NavTabs.init();
...
/* harmony import */ var _Notify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Notify */ "./src/js/modules/Notify.js");
...
var SliderGallery = {
  ...
  _handleQuickViewOpen: function _handleQuickViewOpen(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.get(url).done(function (data) {
      ...
      _Notify__WEBPACK_IMPORTED_MODULE_3__["default"].error("Ошибка при запросе: " + url);
    });
  },
  ...
  init: function init() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on("resize", Object(throttle_debounce__WEBPACK_IMPORTED_MODULE_2__["throttle"])(250, this._handleWindowResize.bind(this)));
